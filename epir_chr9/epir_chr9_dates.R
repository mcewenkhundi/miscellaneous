...
# Use with caution, use function guess_dates from linelist package
linelist::guess_dates(c(
  "03 Jan 2018",
  "07/03/1982",
  "08/20/85"
))
...
# Why do we have missing values above?
...
# summary stats of admission delay by fever etc
linelist %>%
  group_by(fever) %>%
