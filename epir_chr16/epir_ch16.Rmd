...
#using base R version
 sum(linelist[["age_years"]], na.rm = TRUE)/
  sum(!is.na(linelist[["age_years"]]))
...
num_vec[i] <- mean_fn_base(var_ofinterest[i])
...
map(c("age_years", "generation"),mean_fn_base)
